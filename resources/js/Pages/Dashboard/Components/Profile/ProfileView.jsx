            ...
            <div className="grid gap-6 xl:grid-cols-[1.4fr_0.9fr]">
                    ...
                    <div className="rounded-3xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center justify-center rounded-2xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white transition hover:bg-slate-700 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200"
                            >
                                Ver Rede Social
                            </Link>
                        </div>
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400">
                                        ...
                                        concluído ({xpTotal}/{xpProximoNivel}{" "}
                                        XP)
                                    </p>
                                </div>
                ...
                <aside className="space-y-6">
                    <div className="rounded-3xl bg-white dark:bg-gray-800 shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                        ...
                        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                            Atualiza o teu email pessoal para que outros alunos
                            possam encontrar-te fora da plataforma.
                        </p>
