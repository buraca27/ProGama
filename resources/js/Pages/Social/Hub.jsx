        ...
        <AuthenticatedLayout>
            ...
            <div className="space-y-6">
                <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <Link href={route("gamificacao.leaderboard")} className="rounded-xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white dark:bg-slate-100 dark:text-slate-900">
                        Ver Leaderboard
                    </Link>
                </div>
